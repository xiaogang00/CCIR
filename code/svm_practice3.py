...
def evaluate(q, item, word, clf1):
    ...
    for echo in range(2000):
        ...
        test_data = get_data(start, end, q, item, word)
        test_label = get_label(start, end)
        label_len = []
        for number3 in range(5):
            test_label1 = get_label(start + number3, start + number3 + 1)
...
if __name__ == "__main__":
    ...
    x = get_data(start, end, q, item, word)
